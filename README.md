[![Build Status](https://dev.azure.com/tnrdev/projects/_apis/build/status%2Fsrizan.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/tnrdev/projects/_build/latest?definitionId=256&branchName=main)
